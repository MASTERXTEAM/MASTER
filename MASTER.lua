...
sudo_users = {SUDO,1021410039,1216110209}   
...
if tonumber(user_id) == tonumber(1021410039) then  
var = true  
...
local MASTER_Msg = ''  
if msgs < 100 then 
MASTER_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
MASTER_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
MASTER_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
MASTER_Msg = 'متفاعل' 
elseif msgs < 1200 then 
MASTER_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
MASTER_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
MASTER_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
MASTER_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
MASTER_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MASTER_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MASTER_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MASTER_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
MASTER_Msg = 'رب التفاعل'  
end 
return MASTER_Msg 
end
...
function plugin_MASTER(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.MASTER and msg then
pre_msg = plugin.MASTER(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function MASTERXTEAM(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,MASTER_Msg) 
return false  
end 
if text then    
...
if text == '『تفعيل الخدمي』' and SudoBot(msg) then  
...
if text == '『تعطيل الخدمي』' and SudoBot(msg) then  
...
file = download_to_file(url1,'MASTER.webp')
print('TIMESSSS')
local MASTER = 'https://api.telegram.org/bot' .. token .. '/sendDocument'
local curl = 'curl "' .. MASTER .. '" -F "chat_id=' .. msg.chat_id_ .. '" -F "document=@' .. 'MASTER.webp' .. '"'
io.popen(curl)
end

if text == 'تحديث السورس' and SudoBot(msg) then 
os.execute('rm -rf MASTER.lua')
os.execute('wget https://raw.githubusercontent.com/MASTERXTEAM/MASTER/master/MASTER.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n●》لديك اخر اصدار سورس ماستر\n●》الاصدار ← { 1.2v}')
dofile('MASTER.lua')  
end
if text == '『الاصدار』' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'●》اصدار سورس ماستر \n📟| الاصدار ←{ 1.2v}') 
end
...
send(msg.chat_id_, msg.id_,'●》عدد المجموعات الان » { '..#group..' }'..MASTERk..''..MASTER..'\n*-الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n●》العضو » ['..result.title_..'](t.me/'..(username or 'SQlQS')..')'
...
usertext = '\n●》العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SQlQS')..')'
status  = '\n●》تم ترقيته مطور في البوت'
...
if sadam1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'●》العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SQlQS')..') \n - '..sadam1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/SQlQS)}\n●》["..sadam_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "-عذرا يا » {["..data.first_name_.."](t.me/SQlQS)}\n●》الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'●》بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SQlQS')..') \n●》تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'●》بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SQlQS')..') \n●》تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n●》لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SQlQS')..')'
status  = '\n●》تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n●》العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'●》بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SQlQS')..') \n●》تـم قفـل التفليش ')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n●》العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SQlQS')..')'..'\n●》تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماستر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ماستر')
local MASTER_Msg = {
...
send(msg.chat_id_, msg.id_,'['..MASTER_Msg[math.random(#MASTER_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماستر').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SQlQS')..')'
local iduser = result.sender_user_id_
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ماستر')
...
MASTER = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MASTER)
...
--------------------------------------------------------------------------------------------------------------
MASTERXTEAM(data.message_,data)
plugin_MASTER(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local MASTERAbot = database:get(bot_id.."MASTER1:Add:Filter:Rp2"..text..result.chat_id_)   
if MASTERAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"●》العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n●》["..MASTERAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MASTER1_Msg = database:get(bot_id.."MASTER1:Add:Filter:Rp2"..text..result.chat_id_)   
if MASTER1_Msg then    
send(msg.chat_id_, msg.id_,"●》"..MASTER1_Msg)
